...
source /home/pixel/miniconda3/bin/activate geo
...
# gdal_calc.py -A final/rgb/_crop_C01_.tif -B final/rgb/_crop_C02_.tif -B final/rgb/_crop_C03_.tif --outfile=final/rgb/_green_.tif --calc="(0.45*A)+(0.45*B)+(0.10*C)" 
